...
namespace _3rd_TEAM_PROJECT
{
    public partial class S_Process : Form
    {
        ...
        public event EventHandler<string> ProcessCodeSelected;
        public S_Process()
        {
            InitializeComponent();
        ...
        private void btnSelect_Process_Click(object sender, EventArgs e)
        {
            if (dgvSProcess.SelectedCells.Count > 0)
            {
                ...
                {
                    ProcessCodeSelected?.Invoke(this, processCode);
