namespace _3rd_TEAM_PROJECT
{
    partial class Main
    {
		...
		private void InitializeComponent()
		{
			...
			in_name = new DataGridViewTextBoxColumn();
			in_amount = new DataGridViewTextBoxColumn();
			in_contact = new DataGridViewTextBoxColumn();
			in_regdate = new DataGridViewTextBoxColumn();
			...
			out_name = new DataGridViewTextBoxColumn();
			out_amount = new DataGridViewTextBoxColumn();
			out_contact = new DataGridViewTextBoxColumn();
			out_regdate = new DataGridViewTextBoxColumn();
			...
			// textBox33
			// 
			textBox33.Location = new Point(78, 205);
			textBox33.Name = "textBox33";
			textBox33.Size = new Size(100, 23);
			textBox33.TabIndex = 7;
			// 
			// label32
			// 
			...
			// textBox32
			// 
			textBox32.Location = new Point(78, 176);
			textBox32.Name = "textBox32";
			textBox32.Size = new Size(100, 23);
			textBox32.TabIndex = 6;
			// 
			// label31
			// 
			...
			// textBox31
			// 
			textBox31.Location = new Point(78, 147);
			...
			// textBox5
			// 
			textBox5.Location = new Point(78, 31);
			...
			// textBox6
			// 
			textBox6.Location = new Point(78, 118);
			...
			// textBox7
			// 
			textBox7.Location = new Point(78, 60);
			...
			// textBox8
			// 
			textBox8.Location = new Point(78, 92);
			...
			// in_product
			// 
			in_product.HeaderText = "품명";
			in_product.Name = "in_product";
			in_product.ReadOnly = true;
			in_product.Width = 120;
			// 
			// in_code
			// 
			in_code.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			in_code.HeaderText = "품목";
			in_code.Name = "in_code";
			in_code.ReadOnly = true;
			// 
			// in_name
			// 
			in_name.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			in_name.HeaderText = "거래처";
			in_name.Name = "in_name";
			in_name.ReadOnly = true;
			// 
			// in_amount
			// 
			in_amount.HeaderText = "수량";
			in_amount.Name = "in_amount";
			in_amount.ReadOnly = true;
			in_amount.Width = 80;
			// 
			// in_contact
			// 
			in_contact.HeaderText = "담당자";
			in_contact.Name = "in_contact";
			in_contact.ReadOnly = true;
			// 
			// in_regdate
			// 
			in_regdate.HeaderText = "입고일";
			in_regdate.Name = "in_regdate";
			in_regdate.ReadOnly = true;
			// 
			// Purches_insrch
			// 
			...
			groupBox3.Controls.Add(textBox37);
			...
			// textBox39
			// 
			textBox39.Location = new Point(80, 205);
			textBox39.Name = "textBox39";
			textBox39.Size = new Size(100, 23);
			textBox39.TabIndex = 7;
			// 
			// label37
			// 
			...
			// textBox38
			// 
			textBox38.Location = new Point(80, 176);
			textBox38.Name = "textBox38";
			textBox38.Size = new Size(100, 23);
			textBox38.TabIndex = 6;
			// 
			// label36
			// 
			...
			// textBox37
			// 
			textBox37.Location = new Point(80, 118);
			...
			// textBox9
			// 
			textBox9.Location = new Point(80, 34);
			...
			// textBox10
			// 
			textBox10.Location = new Point(80, 147);
			...
			// textBox11
			// 
			textBox11.Location = new Point(80, 63);
			...
			// textBox12
			// 
			textBox12.Location = new Point(80, 92);
			...
			// out_product
			// 
			out_product.HeaderText = "품명";
			out_product.Name = "out_product";
			out_product.ReadOnly = true;
			out_product.Width = 120;
			// 
			// out_code
			// 
			out_code.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			out_code.HeaderText = "품목";
			out_code.Name = "out_code";
			out_code.ReadOnly = true;
			// 
			// out_name
			// 
			out_name.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
			out_name.HeaderText = "거래처";
			out_name.Name = "out_name";
			out_name.ReadOnly = true;
			// 
			// out_amount
			// 
			out_amount.HeaderText = "수량";
			out_amount.Name = "out_amount";
			out_amount.ReadOnly = true;
			out_amount.Width = 80;
			// 
			// out_contact
			// 
			out_contact.HeaderText = "담당자";
			out_contact.Name = "out_contact";
			out_contact.ReadOnly = true;
			// 
			// out_regdate
			// 
			out_regdate.HeaderText = "입고일";
			out_regdate.Name = "out_regdate";
			out_regdate.ReadOnly = true;
			// 
			// Purches_outsrch
			// 
		...
		private DataGridViewTextBoxColumn in_name;
		private DataGridViewTextBoxColumn in_amount;
		private DataGridViewTextBoxColumn in_contact;
		private DataGridViewTextBoxColumn in_regdate;
		private DataGridViewTextBoxColumn out_id;
		private DataGridViewTextBoxColumn out_product;
		private DataGridViewTextBoxColumn out_code;
		private DataGridViewTextBoxColumn out_name;
		private DataGridViewTextBoxColumn out_amount;
		private DataGridViewTextBoxColumn out_contact;
		private DataGridViewTextBoxColumn out_regdate;
